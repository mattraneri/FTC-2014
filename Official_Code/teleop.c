...
#pragma config(Servo,  srvo_S1_C4_1,    rightPlow,            tServoContinuousRotation)
#pragma config(Servo,  srvo_S1_C4_2,    leftPlow,             tServoContinuousRotation)
#pragma config(Servo,  srvo_S1_C4_3,    basket,               tServoStandard)
...
task main()
{
	...
	while (1) {
		...
		readJoys1();
		readButtons1();
		//iteDebugStreamLine("%d", servo[leftPlow];
		// Controller 2
		readJoys2();
		readButtons2();
		joy2Dpad();
